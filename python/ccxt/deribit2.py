...
class deribit2(Exchange):
    ...
    def fetch_markets(self, params={}):
        ...
        for i in range(0, len(currencies)):
            instrumentsResponse = self.publicGetInstruments({'currency': currencies[i]['currency']})
    ...
    def fetch_balance(self, params={}):
        ...
        for i in range(0, len(currencies)):
            ...
            accountSummaryResponse = self.privateGetAccountSummary({'currency': currentCurrency})
    ...
    def fetch_deposit_address(self, currency, params={}):
        response = self.privateGetAccountSummary({'currency': currency})
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        if since is not None:
            ...
            response = self.publicGetLastTradesByInstrumentAndTime(self.extend(request, params))
        else:
            response = self.publicGetLastTradesByInstrument(self.extend(request, params))
    ...
    def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        response = self.publicGetTradingviewChartData(self.extend(request, params))
        #
        #     {
        #         "success": True,
        #         "result":[
    ...
    def edit_order(self, id, symbol, type, side, amount=None, price=None, params={}):
        ...
        if price is not None:
            request['price'] = price
        response = self.privateEdit(self.extend(request, params))
    ...
    def cancel_order(self, id, symbol=None, params={}):
        ...
        response = self.privateCancel(self.extend(request, params))
        return self.parse_order(response['result']['order'])
    ...
    def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = self.privateGetOpenOrdersByInstrument(self.extend(request, params))
    ...
    def fetch_closed_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = self.privateGetOrderHistoryByInstrument(self.extend(request, params))
        return self.parse_orders(response['result'], market, since, limit)
    ...
    def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = self.privateGetUserTradesByInstrument(self.extend(request, params))
    ...
    def sign_in(self, params={}):
        ...
        response = self.publicAuth(self.extend(data, params))
        result = self.safe_value(response, 'result')
